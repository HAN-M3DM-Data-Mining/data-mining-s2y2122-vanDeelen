...
#Notes on broken code

Following the assignment, I have made a second file of this code and broke that code.
To break this code, I did the following:

1. Chunk 3, line 39: changed 'rawDF' to 'ravDF'
2. Chunk 4, line 48: changed 'relevel("Unreliable")' to 'relevel(Umreliable)'
3. Chunk 5, line 60: changed 'max.words = 20' to 'max.words = 2'
4. Chunk 6, line 70: changed 'VectorSource' to 'VectorSauce'
5. Chunk 6, line 71: changed 'rawCorpus' to 'rawCarp'
6. Chunk 7, line 85: removed 'tm_map(stripWhitespace)
7. Chunk 9, line 91: changed 'tibble' to 'pebble'
8. Chunk 9, line 98: changed 'inspect(cleanDTM)' to 'inspect(cleanDTN)'
9. Chunk 11, lines 114 & 115: changed 'rawDF' to 'rawDE' on both lines
10. Chunk 16, line 176: changed 'testDF' to 'testTF'

#Sources
Kaggle. (z.d.). Fake News | Kaggle. Geraadpleegd op 15 maart 2022, van https://www.kaggle.com/c/fake-news/data?select=train.csvTen 

Hove, W. (2021, 21 februari). Module 3 Probabilistic Learning with Naive Bayes Classification | Data Mining. businessdatasolutions.github. Geraadpleegd op 14 maart 2022, van https://businessdatasolutions.github.io/courses/data%20mining/gitbook/book-output/naivebayes.html